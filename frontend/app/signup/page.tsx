...
import { Sparkles, Mail, Lock, Eye, EyeOff, Github, User } from "lucide-react"
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Join AdFlow and start creating amazing AI-powered content
            </p>
          </div>
            ...
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSignUp} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="fullName" className="text-sm font-medium" style={{ color: colors.ink }}>
                    Full Name
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-sm font-medium" style={{ color: colors.ink }}>
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
              ...
              <p className="text-center text-sm text-gray-600 mt-6">
                ...
                <Link href="/signin" className="font-semibold hover:underline" style={{ color: colors.primary }}>
                  Sign in
                </Link>
              </p>
            </CardContent>
